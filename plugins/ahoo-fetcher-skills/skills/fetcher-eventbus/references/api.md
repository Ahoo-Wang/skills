# Fetcher Eventbus API Reference

## Contents

- [Core Concepts](#core-concepts)
  - [TypedEventBus<EVENT> Interface](#typedeventbusevent-interface)
  - [AbstractTypedEventBus<EVENT>](#abstracttypedeventbusevent)
  - [EventHandler<EVENT>](#eventhandlerevent)
  - [NameGenerator](#namegenerator)
- [Event Bus Implementations](#event-bus-implementations)
  - [1. SerialTypedEventBus](#1-serialtypedeventbus)
  - [2. ParallelTypedEventBus](#2-paralleltypedeventbus)
  - [3. BroadcastTypedEventBus](#3-broadcasttypedeventbus)
  - [Generic EventBus<Events>](#generic-eventbusevents)
- [Cross-Tab Messengers](#cross-tab-messengers)
  - [CrossTabMessenger Interface](#crosstabmessenger-interface)
  - [BroadcastChannelMessenger](#broadcastchannelmessenger)
  - [StorageMessenger](#storagemessenger)
  - [createCrossTabMessenger() Fallback Chain](#createcrosstabmessenger-fallback-chain)
